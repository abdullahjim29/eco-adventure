...
const Login = () => {
  return (
	...
	<form noValidate="" action="" className="space-y-6">
		...
		<button className="block w-full p-3 text-center rounded-sm text-white font-semibold bg-[#583CEA]">Login</button>
	</form>
	...
	<p className="text-xs text-center sm:px-6 dark:text-gray-600">Don't have an account?
		<Link to='/auth/register' rel="noopener noreferrer" href="#" className="underline dark:text-gray-800">Register</Link>
	</p>
</div>
    </div>
  );
