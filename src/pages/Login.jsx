    ...
    <div className="flex flex-col md:flex-row justify-center py-10 gap-0 md:gap-20">
      ...
      <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800 border border-gray-300">
        ...
        <div className="flex justify-center space-x-4">
          <button onClick={handleGoogleLogin} aria-label="Log in with Google" className="p-3 rounded-sm btn border-none hover:bg-white">
            <svg
        ...
        <p className="text-xs text-center sm:px-6 dark:text-gray-600">
          ...
          <Link to="/auth/register" className="underline dark:text-gray-800">
            Register
          </Link>
        </p>
      </div>
